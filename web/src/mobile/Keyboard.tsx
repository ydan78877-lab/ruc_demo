...
export function KeyboardProvider({ children, enabled = true }: PropsWithChildren<{ enabled?: boolean }>) {
  ...
  const value = useMemo<KeyboardContextValue>(
    ...
    [dragOffset, enabled, focusedElement, fullHeight, isDragging, visible],
  );
